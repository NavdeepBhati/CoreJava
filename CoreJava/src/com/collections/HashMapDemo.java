...
public class HashMapDemo {
	...
	public static void main(String[] args) {
		...
		HashMap<Movie, String> map = new LinkedHashMap<Movie, String>();
		map.put(m, "ThankYou");
		map.put(m1, "Khiladi");
		map.put(m2, "Tasvir");
		...
		for (Movie mm : map.keySet()) {
			...
			System.out.println(mm.toString() +"   "+map.get(mm).toString());
		}
...
/* We are trying to retrieve m2, by creating object m4 with exact values as of m2, However Hashcode method is not implemented and that why we are not able to get Object m2 */
		if(map.get(m4) == null ){
			...
			System.out.println("m4   "+m4.toString() +"   "+map.get(m4).toString());
		}
	}
}
